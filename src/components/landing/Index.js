    ...
    <>
      <div className="flex xxs:flex-col lg:flex-row justify-evenly xxs:px-2 md:pl-5 xxs:py-[2rem] sm:py-[4rem] lg:pt-[10rem] bg-webRed bg-opacity-5">
        <div className="flex-row md:mx-7">
          ...
          <button className="bg-btn xxs:mt-5 md:ml-0 xxs:ml-[0 rem]  opacity-75 border-none hover:opacity-100  text-white p-3 mt-7 hover:scale-105 box-border hover:shadow-2xl rounded-xl ">
            {props.button}
          </button>
        </div>
