...
const StudentReview = (props) => {
  return (
    <div className="xxs:mr-2 p-2 xxs:w-[100%] md:w-[95%] lg:w-[95%] lg:mr-4 border-solid  bg-opacity-10 mb-6 shadow-3xl hover:shadow-4xl hover:bg-opacity-20 rounded-[30px] bg-webGreen">
