...
const GettingStarted = (props) => {
  return (
    <div className="flex xxs:mb-[2rem] lg:mb-[5rem] font-raleway relative hover:scale-105 xxs:flex-col md:mx-2 pt-6 pb-9 px-5 bg-opacity-10 shadow-3xl hover:shadow-xl hover:bg-opacity-0 rounded-[30px] bg-webGreen my-[1rem]">
